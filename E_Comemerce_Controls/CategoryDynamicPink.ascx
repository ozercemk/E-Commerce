<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CategoryDynamicPink.ascx.cs" Inherits="E_Comemerce_Controls_CategoryDynamicPink" %>
<div class="category-featured fashion">
             <nav class="navbar nav-menu show-brand">
              <div class="container">
                <!-- Brand and toggle get grouped for better mobile display -->
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="assets/data/icon-fashion.png" />MODA</a></div>
