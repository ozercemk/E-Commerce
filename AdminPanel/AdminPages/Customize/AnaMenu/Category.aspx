<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Category.aspx.cs"   EnableEventValidation="false"  ValidateRequest="false" Inherits="AdminPanel_AdminPages_Admin" %>
		...
		<div class="accordion" style="width:740px;"> <!--Acordion Başlangıç-->
              ...
              <h3>Kayıt Seçenekleri </h3>
               ...
               <h3>Önceki Kayıtlar</h3>
	            <p>Lütfen güncelemek istediğiniz kayıdını yanındaki güncelle iconu'na tıklayınız ve 
                   ...
                   <asp:DataGrid ID="DataGrid1" runat="server"
                        ...
                        <AlternatingItemStyle BackColor="White" />
                         <Columns>
                            <asp:BoundColumn DataField="Category_ID" Visible="False"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="Category_Title" HeaderText="Ürün İsmi"></asp:BoundColumn>
	            ...
	            <h3>Lütfen Kategori  İsmi Giriniz </h3>
	            ...
	            <h3>Lütfen Kategori Kısa Açıklama Giriniz </h3>
	           <p>Görünmesini istediğiniz kısa açıklamayı giriniz.<br /><br />
	              ...
	              <h3>Ürün Ana Resim Yüklemesi Yapınız </h3>  
	                <p> Yüklemek istediğiniz resmi  "gözat" seçeneğinden seçin<br /><br />
                     ...
                     <h3>Lütfen  Kategorisini Giriniz </h3>
	            ...
	            <p>Görünmesini istediğiniz Kategori Seçiniz.<br /><br />
                   ...
                   <asp:TextBox ID="Category_Text"  runat="server" ></asp:TextBox>
			   </p>
               
	            <h3>Kategori İçerik Metni Ekleme  </h3>
	            <p><br />
