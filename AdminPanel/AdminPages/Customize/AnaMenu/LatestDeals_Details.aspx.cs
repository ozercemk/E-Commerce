...
public partial class AdminPanel_AdminPages_Admin : System.Web.UI.Page
{
    ...
    protected void DataGrid1_EditCommand(object source, DataGridCommandEventArgs e) // DataGrid Güncelleme İşlemi 
    {
        ...
        NewsSql.GetRecordXML_SUB("SUBPRODUCT_PROC_ID_UPDATES", Txt_Ttl, Slider_Check, Lbl_Txt_Pic, L_Id, Product_image, Keywords_TXT,UrunDrop,Stok_Txt);
   ...
   protected void DataGrid1_ItemDataBound(object sender, DataGridItemEventArgs e) //DataGrid Veri Bağlama İşlemi
    ...
    protected void INSERT_Click(object sender, EventArgs e)
    {
        ...
        db.SP("exec SUBPRODUCT_PROC_INSERT_UPDATE @P0,@P1,@P2,@P3,@P4,@P5,@P6,@P7,@P8", int.Parse(Request["Product_ID"]), Txt_Ttl.Text, Lbl_Txt_Pic.Text, Slider_Check.Checked, Date, int.Parse(L_Id.Text), Keywords_TXT.Text, UrunDrop.SelectedItem.Value,Stok_Txt.Text);
        NewsSql.GetRecords(DataGrid1, "SUBPRODUCT_PROC_ID", int.Parse(Request["Product_ID"]));
        Clear();
