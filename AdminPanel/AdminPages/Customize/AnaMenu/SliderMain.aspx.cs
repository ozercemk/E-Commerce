...
public partial class AdminPanel_AdminPages_Admin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            NewsSql.GetRecords(DataGrid1, "PRODUCT_PROC_AREA", "Slider");
            Clear();
    ...
    protected void DataGrid1_EditCommand(object source, DataGridCommandEventArgs e) // DataGrid Güncelleme İşlemi 
    {
        ...
        NewsSql.GetRecordXML("PRODUCT_PROC_ID_AREA", Txt_Ttl, Txt_Shrt, Lbl_Txt_Pic, Editor_Text_Box, "Slider", L_Id, Live_Check, Product_Image, DropDownList1, Price_Txt, Product_Counter, Product_Status, Brand_Drp, Reduce_Price_Txt, Ratio_Reduce_TXT, Product_Type_DRP);
    ...
    protected void DataGrid1_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
    {
        ...
        NewsSql.FillDataGrid("PRODUCT_PROC_AREA", DataGrid1, "Slider");
   ...
   public void ItemsGrid_Command(Object sender, DataGridCommandEventArgs e)
    ...
    protected void INSERT_Click(object sender, EventArgs e)
    {
        ...
        if (L_Id.Text == "" || string.IsNullOrEmpty(L_Id.Text))
        {
           ...
           db.SP("exec PRODUCT_PROC_INSERT_UPDATE @P0,@P1,@P2,@P3,@P4,@P5,@P6,@P7,@P8,@P9,@P10,@P11,@P12,@P13,@P14,@P15,@P16,@P17,@P18,@P19", int.Parse(L_Id.Text), Txt_Ttl.Text, Txt_Shrt.Text, Lbl_Txt_Pic.Text, Editor_Text_Box.Text, "Slider", Date, Live_Check.Checked, DropDownList1.SelectedValue, Price_Txt.Text, Product_Counter.Text, Product_Status.SelectedItem.Value, Brand_Drp.SelectedItem.Text, Reduce_Price_Txt.Text, Ratio_Reduce_TXT.Text, Product_Type_DRP.SelectedItem.Text, "", "", "", "");
           NewsSql.GetRecords(DataGrid1, "PRODUCT_PROC_AREA", "Slider");
           Clear();
    }
