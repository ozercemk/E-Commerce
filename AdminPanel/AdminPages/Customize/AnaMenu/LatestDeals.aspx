<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LatestDeals.aspx.cs"   EnableEventValidation="false"  ValidateRequest="false" Inherits="AdminPanel_AdminPages_Admin" %>
		...
		<div class="accordion" style="width:740px;"> <!--Acordion Başlangıç-->
             ...
             <h3>Yayınlama Seçenekleri </h3>
               ...
               <h3>Önceki Kayıtlar</h3>
            	...
            	<h3>Lütfen Ürün  İsimi Giriniz </h3>
	            <p>Ürün İsmi giriniz.<br/><br/>
	            <asp:Label ID="LBL_Txt" Visible="true" runat="server" Font-Underline="True"  Font-Bold="True" Text="Başlık :"></asp:Label>
				<asp:TextBox ID="Txt_Ttl"   runat="server" Width="413px"></asp:TextBox>
				</p>
	           <h3>Lütfen Ürün Kısa Açıklama Giriniz </h3>
	           <p>Görünmesini istediğiniz kısa açıklamayı giriniz.<br /><br />
	               <asp:Label ID="Label11" runat="server" Font-Underline="True" Font-Bold="True" Text="Kısa Açıklama  : "></asp:Label><br />
				   <asp:TextBox ID="Txt_Shrt"  TextMode="MultiLine"  runat="server" Width="700px" Height="100px" ></asp:TextBox>
			   </p>
            <h3>Lütfen Ürün Zaman Bilgisini Giriniz </h3>
	           <p>Görünmesini istediğiniz kısa açıklamayı giriniz.<br /><br />
	               <asp:Label ID="Label2" runat="server" Font-Underline="True" Font-Bold="True" Text="Zaman Bilgisi  : "></asp:Label><br /><br />
				    GÜN  :  <asp:TextBox ID="TXT_DAY"    runat="server" Width="50px" Height="20px" ></asp:TextBox> &nbsp;
                    AY   : <asp:TextBox ID="TXT_MONTH"    runat="server" Width="50px" Height="20px" ></asp:TextBox> &nbsp;
                    YIL  : <asp:TextBox ID="TXT_YEAR"    runat="server" Width="50px" Height="20px" ></asp:TextBox> &nbsp;
                    SAAT : <asp:TextBox ID="TXT_TIME"    runat="server" Width="50px" Height="20px" ></asp:TextBox> 
			   </p>

            <h3>Lütfen Ürün Markasını Giriniz </h3>
	           <p>Görünmesini istediğiniz kısa açıklamayı giriniz.<br /><br />
	               <asp:Label ID="Label1" runat="server" Font-Underline="True" Font-Bold="True" Text="Marka İsmi  : "></asp:Label><br /><br />
                ...
                <h3>Lütfen Ürün Kategorisini Giriniz </h3>
	            <p>Görünmesini istediğiniz Kategori Seçiniz.<br /><br />
	                <asp:Label ID="Categor_LBL" runat="server" Font-Underline="True" Font-Bold="True" Text="Kategory  : "></asp:Label><br /><br />
               ...
               <h3>Lütfen Ürün Fiyatını Giriniz </h3>
              ...
              <h3>Lütfen Ürün Stok Adedini Giriniz </h3>
	            <p> <asp:Label ID="Stock_LBL" runat="server" Font-Underline="True" Font-Bold="True" Text="Ürün Stok Adet Miktarı : "></asp:Label><br /><br />
                    <asp:TextBox ID="Product_Counter"  runat="server" ></asp:TextBox>
                </p>
               <h3>Lütfen Ürün Statüsünü Giriniz </h3>
	            <p> <asp:Label ID="Prostatus_Lbl" runat="server" Font-Underline="True" Font-Bold="True" Text="Ürün Statüsü : "></asp:Label><br /><br />
              ...
              <h3>Lütfen Ürün Tipini Giriniz </h3>
               ...
               <h3>Ürün İçerik Metni Ekleme  </h3>
	            <p><br />
