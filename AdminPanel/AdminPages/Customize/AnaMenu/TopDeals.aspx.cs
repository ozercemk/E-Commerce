...
public partial class AdminPanel_AdminPages_Admin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            NewsSql.GetRecords(DataGrid1, "PRODUCT_PROC_AREA", "TD");
            Clear();
    ...
    protected void DataGrid1_EditCommand(object source, DataGridCommandEventArgs e) // DataGrid Güncelleme İşlemi 
    {
        ...
        NewsSql.GetRecordXML("PRODUCT_PROC_ID_AREA", Txt_Ttl, Txt_Shrt, Lbl_Txt_Pic, Editor_Text_Box, "TD", L_Id, Live_Check, Product_Image, DropDownList1, Price_Txt, Product_Counter, Product_Status, Brand_Drp, Reduce_Price_Txt, Ratio_Reduce_TXT, Product_Type_DRP,TXT_DAY,TXT_MONTH,TXT_YEAR,TXT_TIME);
   ...
   public void ItemsGrid_Command(Object sender, DataGridCommandEventArgs e)
    {
        ...
        switch (((ImageButton)e.CommandSource).CommandName)
        {
            ...
            case "Product_Content":
                Response.Redirect("~/AdminPanel/AdminPages/Customize/AnaMenu/TopDeals_Details.aspx?Product_ID=" + e.Item.Cells[0].Text);
             break;
             default:
                // Do nothing.
             break;
